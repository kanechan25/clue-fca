...
export const UserSettings = ({ user }: UserSettingsProps) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: 'Sign Out',
      action: handleLogout,
      className: 'cursor-pointer text-red-600 hover:bg-red-50 border-t border-gray-100',
    },
  ]
    ...
    <>
      <div className='relative' ref={dropdownRef}>
        ...
        <button
          ...
          className='flex items-center space-x-3 p-1 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors'
        >
